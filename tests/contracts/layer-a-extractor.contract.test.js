      ...
      describe.each(extensions)('Extension: %s', (ext) => {
        ...
        describe('Structure Contract', () => {
          ...
          it('MUST return all required fields', () => {
            const result = parseFile(`test.${ext}`, '');
          ...
          it('MUST return arrays for collection fields', () => {
            const result = parseFile(`test.${ext}`, '');
          ...
          it('MUST return strings for text fields', () => {
            const result = parseFile(`test.${ext}`, '');
        ...
        describe('Functionality Contract', () => {
          ...
          if (testCases.imports) {
            it('MUST extract imports', () => {
              const result = parseFile(`test.${ext}`, testCases.imports);
              expect(result.imports.length).toBeGreaterThan(0);
            });
          }
          
          if (testCases.exports) {
            it('MUST extract exports', () => {
              const result = parseFile(`test.${ext}`, testCases.exports);
              expect(result.exports.length).toBeGreaterThan(0);
            });
          }
          
          if (testCases.functions) {
            it('MUST extract functions', () => {
              const result = parseFile(`test.${ext}`, testCases.functions);
              expect(result.functions.length).toBeGreaterThan(0);
            });
          }
          
          if (testCases.classes) {
            it('MUST extract classes', () => {
              const result = parseFile(`test.${ext}`, testCases.classes);
          ...
          if (testCases.types) {
            it('MUST extract type definitions', () => {
              const result = parseFile(`test.${ext}`, testCases.types);
        ...
        describe('Error Handling Contract', () => {
          ...
          it('MUST NOT throw on empty input', () => {
            expect(() => parseFile(`test.${ext}`, '')).not.toThrow();
          });
          
          it('MUST NOT throw on invalid syntax', () => {
            expect(() => parseFile(`test.${ext}`, 'invalid !!! syntax ???')).not.toThrow();
          });
          
          it('MUST return parseError on invalid syntax', () => {
            const result = parseFile(`test.${ext}`, 'invalid !!!');
