/**
 * @fileoverview Race Detector Test Factory
 * 
 * Factory for creating test data for race condition detection.
 * Provides builders for race scenarios, shared state, and project data.
 * 
 * @module tests/factories/race-detector-test
 */

/**
 * Builder for creating race condition scenarios
 */
