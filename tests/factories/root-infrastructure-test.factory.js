/**
 * @fileoverview Root Infrastructure Test Factory
 * 
 * Factory for creating test data for root infrastructure components:
 * - analyzer.js (orchestrator)
 * - indexer.js (main entry)
 * - scanner.js (file discovery)
 * - resolver.js (dependency resolution)
 * 
 * @module tests/factories/root-infrastructure-test.factory
 */
