...
REM Prevenir ejecución múltiple - verificar si ya hay una instancia iniciándose
...
title CogniSystem Brain (GPU - Vulkan) - LFM2.5-Instruct [PID:%RANDOM%]
color 0B
...
REM Verificar que se cerró completamente
:CHECK_PROCESS
...
echo [INFO] Using LFM2.5-Instruct 1.2B for instruction following
