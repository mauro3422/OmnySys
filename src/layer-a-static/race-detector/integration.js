...
function exportToMarkdown(raceResults) {
  ...
  md += `## Summary\n\n`;
  md += `- **Total Races:** ${raceResults.summary.totalRaces}\n`;
  md += `- **Total Warnings:** ${raceResults.summary.totalWarnings}\n`;
  md += `- **Shared State Items:** ${raceResults.summary.sharedStateItems}\n\n`;
  ...
  md += '## Detailed Races\n\n';
  for (const race of raceResults.races) {
