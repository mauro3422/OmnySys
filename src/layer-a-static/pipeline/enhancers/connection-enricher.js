...
import { extractTemporalConnections, extractCrossFileTemporalConnections } from '#layer-a/extractors/metadata/temporal-connections/index.js';
...
async function extractAllConnections(atoms) {
  return {
    temporal: extractTemporalConnections(atoms),
    crossFileTemporal: extractCrossFileTemporalConnections(atoms),
