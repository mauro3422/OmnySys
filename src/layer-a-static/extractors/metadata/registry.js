...
export const BASE_ATOM_FIELDS = [
  ...
  { name: 'testCallbackType', description: 'Test callback type', usedByTools: ['get_atom_schema', 'detect_patterns', 'generate_tests'] },
  ...
  { name: 'usesJson', description: 'Direct uses list', usedByTools: ['get_call_graph', 'explain_value_flow', 'get_function_details'] },
