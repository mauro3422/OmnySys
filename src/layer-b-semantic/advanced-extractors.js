...
console.warn('⚠️  DEPRECATED: Importing from layer-b-semantic/advanced-extractors.js');
console.warn('   Please update imports to: layer-a-static/extractors/advanced-extractors.js');

export * from '../layer-a-static/extractors/advanced-extractors.js';
