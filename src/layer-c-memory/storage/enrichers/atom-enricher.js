...
export function enrichAtom(atom, context = {}) {
  ...
  const enrichedAtom = {
    ...
    propagationScore: vectors.propagationScore,
    fragilityScore: vectors.fragilityScore,
    testabilityScore: vectors.testabilityScore,
    centralityScore: vectors.centralityScore,
    ...
    derived: {
      ...
      centralityScore: vectors.centralityScore,
      couplingScore: vectors.couplingScore,
      changeRisk: vectors.propagationScore
    }
  };
...
export function enrichAtoms(atoms, context = {}) {
  ...
  const finalEnriched = enriched.map(atom => {
    ...
    return {
      ...
      propagationScore: updatedVectors.propagationScore,
      centralityScore: updatedVectors.centralityScore,
