 ...
 *
 * Ejemplos:
 *   node export-system-map.js                    # Usa directorio actual, salida en .aver/debug/
 *   node export-system-map.js /ruta/proyecto     # Proyecto específico, salida en .aver/debug/
...
async function main() {
  try {
    ...
    if (outputPath) {
      ...
      console.log('Output file: .aver/debug/system-map-full.json (default)');
    }
    console.log('');
