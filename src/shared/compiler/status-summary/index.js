...
export function compactCompilerHealthDashboardSummary(dashboard) {
  ...
  return {
    ...
    sessions: compact.sessions ? {
      ...
      transportOriginCounts: compact.sessions.transportOriginCounts || null,
      transportOriginTotal: compact.sessions.transportOriginTotal || 0,
      transportOriginDistinctCount: compact.sessions.transportOriginDistinctCount || 0,
      transportOriginKnownCount: compact.sessions.transportOriginKnownCount || 0,
      dominantTransportOrigin: compact.sessions.dominantTransportOrigin || null,
      dominantTransportOriginCount: compact.sessions.dominantTransportOriginCount || 0,
      transportOriginMix: Array.isArray(compact.sessions.transportOriginMix) ? compact.sessions.transportOriginMix.slice(0, 8) : [],
      transportProvenanceState: compact.sessions.transportProvenanceState || null,
      transportProvenanceHealthy: compact.sessions.transportProvenanceHealthy === true,
      transportProvenanceTrustworthy: compact.sessions.transportProvenanceTrustworthy !== false,
      transportProvenanceReason: compact.sessions.transportProvenanceReason || null,
      transportProvenanceRecommendation: compact.sessions.transportProvenanceRecommendation || null,
      transportProvenanceSummary: compact.sessions.transportProvenanceSummary || null,
      transportSessionStateCounts: compact.sessions.transportSessionStateCounts || null,
      transportRequestPhaseCounts: compact.sessions.transportRequestPhaseCounts || null,
      transportClientRouteIdCounts: compact.sessions.transportClientRouteIdCounts || null,
      transportHandshakeSignatureCounts: compact.sessions.transportHandshakeSignatureCounts || null,
      transportSessionHeaderPresentCount: compact.sessions.transportSessionHeaderPresentCount || 0,
      transportSessionHeaderMissingCount: compact.sessions.transportSessionHeaderMissingCount || 0,
      transportAlertState: compact.sessions.transportAlertState || null,
      transportAlertCount: compact.sessions.transportAlertCount || 0,
      transportAlertHealthy: compact.sessions.transportAlertHealthy === true,
      transportAlertTrustworthy: compact.sessions.transportAlertTrustworthy !== false,
      transportAlertReason: compact.sessions.transportAlertReason || null,
      transportAlertRecommendation: compact.sessions.transportAlertRecommendation || null,
      transportAlertSummary: compact.sessions.transportAlertSummary || null,
      transportAlerts: Array.isArray(compact.sessions.transportAlerts) ? compact.sessions.transportAlerts.slice(0, 6) : []
    } : null,
