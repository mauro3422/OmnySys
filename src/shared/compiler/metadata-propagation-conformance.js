...
function importsCanonicalPropagationApi(source = '') {
  return /getSystemMapPersistenceCoverage|getMetadataSurfaceParity|getMetadataExtractionCoverage|summarizePersistedScannedFileCoverage|getFileImportEvidenceCoverage|ensureLiveRowSync|buildDataGatewayContract|buildSurfaceFreshnessLedger|summarizeDataGatewayContract|summarizeSurfaceFreshnessLedger/.test(source);
}
