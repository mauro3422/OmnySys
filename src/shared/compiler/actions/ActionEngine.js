...
import { simulate_naming_debt_impact } from '../../../layer-c-memory/mcp/tools/naming-debt-impact-simulator.js';
...
const ACTION_HANDLERS = {
  ...
  simulate_naming_debt_impact: async (args, context) => simulate_naming_debt_impact(args.candidatePath, args.projectPath || context?.projectPath),
