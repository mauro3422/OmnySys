...
function compactSurfaceEntry(entry = {}) {
  return {
    key: entry.key || null,
...
function normalizeMetadataSummary(metadataExtractionCoverage = null) {
...
function buildDatabaseMetricsSummary(databaseHealth = null) {
...
function buildMetadataMetricsSummary(metadataSummary = null) {
...
function summarizeSurfaceMetrics({
  databaseHealth = null,
