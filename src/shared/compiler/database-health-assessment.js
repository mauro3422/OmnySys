/**
 * @fileoverview Scoring and finding assembly for canonical database health.
 *
 * Keeps the public database-health summary thin while preserving the same
 * scoring semantics in a smaller helper surface.
 *
 * @module shared/compiler/database-health-assessment
 */
