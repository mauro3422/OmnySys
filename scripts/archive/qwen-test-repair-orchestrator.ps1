$dirs = @('ai', 'audit', 'cli', 'core', 'layer-a-analysis', 'layer-a-core', 'layer-a-static', 'layer-b-semantic', 'layer-c', 'layer-c-memory', 'layer-graph', 'services', 'shared', 'validation')

Write-Host "Started Full Test Suite Audit and Repair via Qwen"
